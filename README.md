...
4. Check the `bitrise.yml` file for any secret you should set in `.bitrise.
5. Run this step with the [bitrise CLI](https://github.com/bitrise-io/bitrise): `bitrise run test`
